...
<head>
  ...
  <meta name="description" content="Selamat Datang di Website Portofolio Rafli Ortega Jaya!">
  <link rel="apple-touch-icon" sizes="76x76" href="<?=base_url()?>assets/landing-page/assets/img/apple-icon.png">
  <link rel="icon" type="image/png" href="<?=base_url()?>assets/landing-page/assets/img/favicon.png">
  <title>
    Portfolio - Rafli Ortega Jaya
  </title>
  <!--     Fonts and icons     -->
  <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900|Roboto+Slab:400,700" />
  <!-- Nucleo Icons -->
  <link href="<?=base_url()?>assets/landing-page/assets/css/nucleo-icons.css" rel="stylesheet" />
  <link href="<?=base_url()?>assets/landing-page/assets/css/nucleo-svg.css" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
  <!-- Material Icons -->
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
  <!-- CSS Files -->
  <link id="pagestyle" href="<?=base_url()?>assets/landing-page/assets/css/material-kit.css?v=3.0.4" rel="stylesheet" />
...
<body class="about-us bg-gray-200">
        ...
        <ul class="navbar-nav navbar-nav-hover ms-auto">
          <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
            <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" id="dropdownMenuPages8" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              Information
              <img src="<?=base_url()?>assets/landing-page/assets/img/down-arrow-white.svg" alt="down-arrow" class="arrow ms-2 d-lg-block d-none">
              <img src="<?=base_url()?>assets/landing-page/assets/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-2 d-lg-none d-block">
            </a>
                  ...
                  <a class="dropdown-item py-2 ps-3 border-radius-md" href="../presentation.html">
                    <div class="w-100 d-flex align-items-center justify-content-between">
                      <div>
                        ...
                        <span class="text-sm">See all themes</span>
                      </div>
                      <img src="<?=base_url()?>assets/landing-page/assets/img/down-arrow.svg" alt="down-arrow" class="arrow">
                    </div>
                  </a>
                  ...
                  <a class="dropdown-item py-2 ps-3 border-radius-md" href="../presentation.html">
                    <div class="w-100 d-flex align-items-center justify-content-between">
                      <div>
                        ...
                        <span class="text-sm">See all aerial imageries</span>
                      </div>
                      <!-- <img src="<?=base_url()?>assets/landing-page/assets/img/down-arrow.svg" alt="down-arrow" class="arrow"> -->
                    </div>
                  </a>
          ...
          <li class="nav-item ms-lg-auto">
            <a class="nav-link nav-link-icon me-2" href="https://github.com/MagnumMelted" target="_blank">
              <i class="fa fa-github me-1"></i>
              <p class="d-inline text-sm z-index-1 font-weight-bold" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Visit my GitHub!">
                MyGithub
              </p>
            </a>
          </li>
          <!-- <li class="nav-item my-auto ms-3 ms-lg-0">
            <a href="https://www.creative-tim.com/product/material-kit-pro" class="btn btn-sm  bg-white  mb-0 me-1 mt-2 mt-md-0">
              Upgrade to Pro
            </a>
          </li> -->
        </ul>
  ...
  <header class="bg-gradient-dark">
    <div class="page-header min-vh-100" style="background-image: url('<?=base_url()?>assets/landing-page/assets/img/bg-unsplash.jpg');">
      <span class="mask bg-gradient-dark opacity-6"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center mx-auto my-auto">
            <h1 class="text-white">Hello, There!</h1>
            <h1 class="text-white">I'm Rafli Ortega Jaya</h1>
            <p class="lead mb-4 text-white opacity-8">
            I am a student at Geographic Information Science, Universitas Pendidikan Indonesia with a keen interest in 
            Geographic Information Systems (GIS), Survey Mapping, and Data Analyst
            </p>
            ...
            <div class="d-flex justify-content-center">
              ...
              <a href="https://www.linkedin.com/in/rafli-ortega-jaya-373118151/" target="_blank" title="LinkedIn || Rafli Ortega Jaya"><i class="fab fa-linkedin text-lg text-white me-4"></i></a>
              <!-- <a href="javascript:;"><i class="fab fa-twitter text-lg text-white me-4"></i></a> -->
              <a href="https://www.instagram.com/ega_ortega/" target="_blank" title="Instagram || ega_ortega"><i class="fab fa-instagram text-lg text-white"></i></a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <a class="d-block blur-shadow-image">
                  <img src="<?=base_url()?>assets/landing-page/assets/img/about-me.JPG" alt="img-colored-shadow" class="img-fluid border-radius-lg">
                </a>
              </div>
              <div class="card-body text-center">
                <h5 class="font-weight-normal">
                  <a href="javascript:;">Rafli Ortega Jaya</a>
                </h5>
                <p class="mb-0">
                  Geographic Information Science, Universitas Pendidikan Indonesia
                </p>
                ...
                <div class="col-lg-4 col-md-6 col-12 mt-n5">
                  <a href="javascript:;">
                    <div class="p-3 pe-md-0">
                      <img class="w-100 border-radius-md shadow-lg" src="<?=base_url()?>assets/landing-page/assets/img/team-5.jpg" alt="image">
                    </div>
                  </a>
                </div>
            ...
            <div class="card card-profile mt-lg-4 mt-5">
              <div class="row">
                <div class="col-lg-4 col-md-6 col-12 mt-n5">
                  <a href="javascript:;">
                    <div class="p-3 pe-md-0">
                      <img class="w-100 border-radius-md shadow-lg" src="<?=base_url()?>assets/landing-page/assets/img/bruce-mars.jpg" alt="image">
                    </div>
                  </a>
                </div>
                <div class="col-lg-8 col-md-6 col-12 my-auto">
            ...
            <div class="card card-profile mt-4 z-index-2">
              <div class="row">
                <div class="col-lg-4 col-md-6 col-12 mt-n5">
                  <a href="javascript:;">
                    <div class="p-3 pe-md-0">
                      <img class="w-100 border-radius-md shadow-lg" src="<?=base_url()?>assets/landing-page/assets/img/ivana-squares.jpg" alt="image">
                    </div>
                  </a>
                </div>
                <div class="col-lg-8 col-md-6 col-12 my-auto">
            ...
            <div class="card card-profile mt-lg-4 mt-5 z-index-2">
              <div class="row">
                <div class="col-lg-4 col-md-6 col-12 mt-n5">
                  <a href="javascript:;">
                    <div class="p-3 pe-md-0">
                      <img class="w-100 border-radius-md shadow-lg" src="<?=base_url()?>assets/landing-page/assets/img/ivana-square.jpg" alt="image">
                    </div>
                  </a>
                </div>
                <div class="col-lg-8 col-md-6 col-12 my-auto">
      ...
      <div class="container">
        <div class="row mb-7">
          <div class="col-lg-2 col-md-4 col-6 mb-4">
            <img class="w-100 opacity-7" src="<?=base_url()?>assets/landing-page/assets/img/logos/gray-logos/logo-coinbase.svg" alt="logo">
          </div>
          <div class="col-lg-2 col-md-4 col-6 mb-4">
            <img class="w-100 opacity-7" src="<?=base_url()?>assets/landing-page/assets/img/logos/gray-logos/logo-nasa.svg" alt="logo">
          </div>
          <div class="col-lg-2 col-md-4 col-6 mb-4">
            <img class="w-100 opacity-7" src="<?=base_url()?>assets/landing-page/assets/img/logos/gray-logos/logo-netflix.svg" alt="logo">
          </div>
          <div class="col-lg-2 col-md-4 col-6 mb-4">
            <img class="w-100 opacity-7" src="<?=base_url()?>assets/landing-page/assets/img/logos/gray-logos/logo-pinterest.svg" alt="logo">
          </div>
          <div class="col-lg-2 col-md-4 col-6 mb-4">
            <img class="w-100 opacity-7" src="<?=base_url()?>assets/landing-page/assets/img/logos/gray-logos/logo-spotify.svg" alt="logo">
          </div>
          <div class="col-lg-2 col-md-4 col-6 mb-4">
            <img class="w-100 opacity-7" src="<?=base_url()?>assets/landing-page/assets/img/logos/gray-logos/logo-vodafone.svg" alt="logo">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-5 ms-auto">
            <div class="position-relative">
              <img class="max-width-50 w-100 position-relative z-index-2" src="<?=base_url()?>assets/landing-page/assets/img/macbook.png" alt="image">
            </div>
          </div>
        </div>
      </div>
  ...
  <footer class="footer pt-5 mt-5">
    <div class="container">
      <div class="row">
        <div class="mb-7 ms-auto"> <!-- col-md-3 mb-4 ms-auto -->
          <div>
            <!-- Logo -->
            <!-- <a href="https://www.creative-tim.com/product/material-kit">
              <img src="<?=base_url()?>assets/landing-page/assets/img/logo-ct-dark.png" class="mb-3 footer-logo" alt="main_logo">
            </a> -->
            <h6 class="font-weight-bolder mb-4">Rafli Ortega Jaya</h6>
          </div>
          <div>
            <ul class="d-flex flex-row ms-n3 nav">
              <li class="nav-item">
                <a class="nav-link pe-1" href="https://www.linkedin.com/in/rafli-ortega-jaya-373118151/" target="_blank">
                  <i class="fab fa-linkedin text-lg opacity-8"></i>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link pe-1" href="https://www.instagram.com/ega_ortega/" target="_blank">
              ...
              <li class="nav-item">
                <a class="nav-link pe-1" href="https://github.com/MagnumMelted" target="_blank">
                  <i class="fab fa-github text-lg opacity-8"></i>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link pe-1" href="https://www.youtube.com/channel/UCMAj-3ds3_kqkslvvWe1KdA" target="_blank">
  ...
  <!--   Core JS Files   -->
  <script src="<?=base_url()?>assets/landing-page/assets/js/core/popper.min.js" type="text/javascript"></script>
  <script src="<?=base_url()?>assets/landing-page/assets/js/core/bootstrap.min.js" type="text/javascript"></script>
  <script src="<?=base_url()?>assets/landing-page/assets/js/plugins/perfect-scrollbar.min.js"></script>
  <!--  Plugin for TypedJS, full documentation here: https://github.com/inorganik/CountUp.js -->
  <script src="<?=base_url()?>assets/landing-page/assets/js/plugins/countup.min.js"></script>
  <!-- Control Center for Material UI Kit: parallax effects, scripts for the example pages etc -->
  <!--  Google Maps Plugin    -->
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDTTfWur0PDbZWPr7Pmq8K3jiDp0_xUziI"></script>
  <script src="<?=base_url()?>assets/landing-page/assets/js/material-kit.min.js?v=3.0.4" type="text/javascript"></script>
  <script>
